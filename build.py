...
DOCS_REG = [
 ...
 ("golive-checkliste","Go-Live-Checkliste (Gründungsphase)","gruendung","A","Leitfaden","entwurf",
   "Konkreter Fahrplan Woche für Woche bis zu den ersten Einsätzen."),
 ...
 ("themenabend-konzept","Themenabend-Konzept (Recruiting)","vertrieb","B","Konzept","entwurf",
   "Recruiting-Event: 30 Interessierte gewinnen und zur Bewerbung führen."),
 ("landingpage-texte","Landingpage-Texte (Kunde & Bewerber)","vertrieb","B","Texte","entwurf",
   "Fertige Website-Texte für die Kunden- und die Bewerber-Landingpage."),
